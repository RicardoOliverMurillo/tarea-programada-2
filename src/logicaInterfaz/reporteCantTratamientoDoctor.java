...
public class reporteCantTratamientoDoctor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					reporteCantTratamientoDoctor frame = new reporteCantTratamientoDoctor();
	...
	public reporteCantTratamientoDoctor() {}

	public reporteCantTratamientoDoctor(int pcedula) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if((d1!=null) && (d2!=null)){
					if(cbTipo.getSelectedItem()!=null|| cbNombre.getSelectedItem()!=null) {
						...
						lblCantConsulta.setText(Integer.toString(infoTratamiento.size()));
					}
