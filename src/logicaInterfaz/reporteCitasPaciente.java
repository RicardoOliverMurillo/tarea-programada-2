...
public class reporteCitasPaciente extends JFrame {
	...
	private JTable tablaReporteCita;
	...
	public reporteCitasPaciente() {
		...
		JLabel lblNewLabel = new JLabel("Reporte Citas ");
		lblNewLabel.setBounds(282, 19, 89, 16);
		...
		tablaReporteCita = new JTable();
		scrollPane.setViewportView(tablaReporteCita);
	}
}
